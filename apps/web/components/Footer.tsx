...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-card border-t border-border/80 pt-16 pb-12 overflow-hidden text-muted-foreground">
      {/* Background Gradient Glows */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-sky-500/10 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-500/10 rounded-full blur-[120px] pointer-events-none -z-10" />

      <div className="w-full px-6 sm:px-12 lg:px-20 max-w-[1550px] mx-auto">
        
        {/* Top Feature Banner & Newsletter CTA */}
        <div className="mb-14 p-8 sm:p-10 rounded-[2.5rem] bg-gradient-to-r from-sky-500/10 via-indigo-500/10 to-purple-500/10 border border-sky-500/20 shadow-xl backdrop-blur-md">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="max-w-xl text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/10 border border-sky-500/30 text-sky-600 dark:text-sky-400 text-xs font-bold uppercase tracking-wider mb-3">
            ...
            <form onSubmit={handleSubscribe} className="w-full lg:w-auto flex-1 max-w-md">
              {subscribed ? (
                <div className="flex items-center justify-center gap-2 p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 text-sm font-bold">
                  <CheckCircle2 className="w-5 h-5" />
                  <span>You're subscribed! Welcome aboard.</span>
                </div>
              ) : (
                <div className="flex flex-col sm:flex-row gap-2 bg-background/80 p-2 rounded-2xl border border-border shadow-inner">
                  <input
                    type="email"
                    required
                    ...
                    className="flex-1 bg-transparent px-4 py-2.5 text-sm text-foreground focus:outline-none placeholder:text-muted-foreground/60 font-medium"
                  />
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-500 hover:to-blue-500 text-white font-bold text-xs uppercase tracking-wider transition-all shadow-md active:scale-95 cursor-pointer"
                  >
                    <span>Subscribe</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2">
            <Link href="/" className="inline-flex items-center gap-2.5 font-black text-2xl text-foreground mb-4 group">
              <div className="p-2.5 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 text-white shadow-lg shadow-sky-500/25 group-hover:scale-105 transition-transform">
            ...
            <div className="flex items-center gap-3">
              ...
              <a 
                ...
                rel="noreferrer" 
                aria-label="GitHub"
                className="p-3 rounded-2xl bg-secondary/80 hover:bg-sky-500/10 hover:text-sky-500 border border-border/80 transition-all hover:scale-110 text-foreground"
              >
          ...
          {/* Links Column 1 */}
          <div>
            <h4 className="font-extrabold text-foreground mb-4 text-xs uppercase tracking-widest text-sky-600 dark:text-sky-400">
              Tool Suites
            </h4>
        ...
        <div className="pt-8 border-t border-border/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold">
