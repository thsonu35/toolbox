...
const POPULAR_TOOLS: Tool[] = [
  {
    ...
    uses: "2.4M+",
    badge: "Most Popular",
    icon: <FileCode2 className="w-7 h-7 text-sky-400" />,
  ...
  },
  {
    ...
    features: ["Batch Processing", "EXIF Data Removal", "Offline Conversion"],
  ...
  },
  {
    ...
    uses: "1.8M+",
    badge: "Essential",
    icon: <FileSpreadsheet className="w-7 h-7 text-rose-400" />,
  ...
  },
  {
    ...
    features: ["Role Framing", "Chain-of-Thought Templates", "1-Click Copy"],
  ...
  },
  {
    ...
    features: ["Custom Entropy Levels", "Bcrypt & SHA-256", "Offline Cryptography"],
...
export default function PopularTools() {
  ...
  return (
    <section id="tools" className="py-16 sm:py-24 bg-background relative overflow-hidden">
      {/* Background Accent Glow */}
      <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-sky-500/10 rounded-full blur-[140px] pointer-events-none -z-10" />

      <div className="w-full px-6 sm:px-12 lg:px-20 max-w-[1550px] mx-auto">
        
        {/* Section Header */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 pb-6 border-b border-border/60 gap-4">
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Left Column */}
          <div className="lg:col-span-7 flex flex-col justify-between bg-card border-2 border-sky-500/30 rounded-[2.5rem] p-8 sm:p-12 relative overflow-hidden shadow-2xl transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-background/90 border border-border shadow-md flex items-center justify-center">
                    {activeTool.icon}
                  </div>
                  <div>
                    <span className={`text-xs font-extrabold uppercase tracking-wider px-3 py-1 rounded-full border ${activeTool.accentColor}`}>
                      {activeTool.category}
                    </span>
                    <h4 className="text-xs font-semibold text-muted-foreground mt-1.5">
                      {activeTool.uses} Executions
                    </h4>
                  </div>
                </div>

                <div className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-background/80 border border-border text-xs font-bold text-foreground">
              ...
              <h3 className="text-2xl sm:text-4xl font-extrabold text-foreground tracking-tight mb-3">
                {activeTool.name}
              </h3>
              <p className="text-lg font-semibold text-sky-600 dark:text-sky-400 mb-4">
                {activeTool.tagline}
              </p>
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                {activeTool.features.map((feat, idx) => (
                  <div 
                    key={idx}
                    className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-background/90 border border-border text-xs font-bold text-foreground shadow-sm"
                  >
            ...
            {/* Launch CTA Bar */}
            <div className="relative z-10 pt-6 border-t border-border/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-700 hover:to-blue-700 text-white font-bold text-base py-4 px-8 rounded-2xl shadow-lg shadow-sky-500/25 transition-all hover:scale-[1.02] active:scale-95"
              >
            ...
            {POPULAR_TOOLS.map((tool) => {
              ...
              return (
                <div
                  ...
                  className={`group p-5 rounded-2xl border-2 transition-all duration-200 cursor-pointer flex items-center justify-between ${
                    isSelected
                      ? "bg-card border-sky-500 shadow-xl scale-[1.02]"
